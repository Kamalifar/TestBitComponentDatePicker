...
namespace TestBitComponentDatePicker.Pages
{
    public class PersianCulture:CultureInfo
    {
            ...
            : base(cultureName, useUserOverride)
        {
            ...
            for (int i = 0; i < newOptionalCalendarIDs.Length; i++)
                ...
                //newOptionalCalendarIDs[i] = Convert.ToInt32(idProperty.GetValue(optionalCalendars[i],null));

            optionalCalendarfield.SetValue(DateTimeFormat, newOptionalCalendarIDs);
            //optionalCalendarfield.SetValue(DateTimeFormat, Convert.ChangeType(newOptionalCalendarIDs,typeof(Calendar)));
